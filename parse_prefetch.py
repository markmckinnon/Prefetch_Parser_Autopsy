...
tableColumns = "prefetch_File_Name text, actual_File_Name text, Number_time_file_run int, Embeded_date_Time_Unix_1 int, " + \
        ...
        if ".pf" in file:
            ...
            try:
                ...
                for i in range(numberVolumes):
                    ...
                    volumeList.append(volumeEntry.get_device_path())
                ...
                for i in range(numberFileNames):
                    ...
                    (path, fileName) = os.path.split(scca.get_filename(i))
